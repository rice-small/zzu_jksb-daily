...
def sign_in(id, pwd, name="Turing", check_today=1):
    ...
    form = {
        ...
        "myvs_13a": "36",  # 省份（自治区）：省份编码  对应身份证前两位  河南省=41
        "myvs_13b": "3601",  # 地市：地级市编码 对应身份证前四位  郑州市=4101
        "myvs_13c": "江西省.南昌市",  # 自己填写当前所在地即可
        "myvs_24": "否",
        ...
        "fun3": "",
        # "jingdu": "115.864589",  # 经度： 北校区经度,jingdu=113.658055
        # "weidu": "28.689455",  # 纬度： 北校区纬度,&weidu=34.782807  东经113.658333北纬34.7822222
        "ptopid": ptopid,
        "sid": sid,
    }
    headers = {
